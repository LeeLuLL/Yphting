...
public class Appraisalapply {
	...
	public String toString() {
		return "Appraisalapply [applyid=" + applyid + ", userid=" + userid + ", stid=" + stid + ", name=" + name
				+ ", sex=" + sex + ", height=" + height + ", constellation=" + constellation + ", age=" + age
				+ ", visatype=" + visatype + ", documenttype=" + documenttype + ", certificates=" + certificates
				+ ", experience=" + experience + ", vehicle=" + vehicle + ", guidecard=" + guidecard + ", inkorea="
				+ inkorea + ", phone=" + phone + ", email=" + email + ", country=" + country + ", provincialid="
				+ provincialid + ", cityid=" + cityid + ", detailed=" + detailed + ", hospitallicense="
				+ hospitallicense + ", cooperativehospital=" + cooperativehospital + ", cooperativehospitalurl="
				+ cooperativehospitalurl + ", hospitalphone=" + hospitalphone + ", translatetype=" + translatetype
				+ ", translate=" + translate + ", office=" + office + ", officecountry=" + officecountry
				+ ", officeprovince=" + officeprovince + ", officecity=" + officecity + ", officedetailed="
				+ officedetailed + ", korealicense=" + korealicense + ", translatewebsite=" + translatewebsite
				+ ", studymajor=" + studymajor + ", schoolreport=" + schoolreport + ", officialnetworkurl="
				+ officialnetworkurl + ", submittime=" + submittime + ", audittime=" + audittime + ", auditstatus="
				+ auditstatus + ", adminopinion=" + adminopinion + "]";
	}
