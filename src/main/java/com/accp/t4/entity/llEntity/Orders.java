...
public class Orders {
	...
	public String toString() {
		return "Orders [orderid=" + orderid + ", userid=" + userid + ", serviceid=" + serviceid + ", resouroeid="
				+ resouroeid + ", ordertype=" + ordertype + ", ordertime=" + ordertime + ", paymenttime=" + paymenttime
				+ ", receipttime=" + receipttime + ", provideservicestime=" + provideservicestime + ", completetime="
				+ completetime + ", scheduledstarttime=" + scheduledstarttime + ", scheduledendtime=" + scheduledendtime
				+ ", population=" + population + ", number=" + number + ", smallplan=" + smallplan + ", totalprice="
				+ totalprice + ", uploadpath=" + uploadpath + ", weight=" + weight + ", integral=" + integral
				+ ", collectgoods=" + collectgoods + ", addressid=" + addressid + ", orderstatus=" + orderstatus
				+ ", commentstatus=" + commentstatus + ", refundstatus=" + refundstatus + ", filesatus=" + filesatus
